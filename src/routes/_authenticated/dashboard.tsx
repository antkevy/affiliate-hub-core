        ...
        <>
          <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
            <StatCard
              ...
              bar="from-chart-3 to-transparent"
              spark={offersSeries}
            ...
            <StatCard
              ...
              bar="from-chart-2 to-transparent"
              delay={40}
            />
            <StatCard
              icon={Megaphone}
              ...
              bar="from-chart-1 to-transparent"
            ...
            <StatCard
              ...
              bar="from-warning to-transparent"
              delay={120}
            />
          </div>

          <section className="animate-rise" style={{ animationDelay: "130ms" }}>
            <div
            ...
            <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
              {quickActions.map((action) => (
                <Link
                  ...
                  className="group flex min-h-[72px] items-center gap-3 rounded-xl border border-border bg-surface/60 p-3 transition-[transform,box-shadow,border-color] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] lg:hover:-translate-y-0.5 lg:hover:border-primary/40 lg:hover:shadow-[var(--shadow-lift)]"
                >
                  <span
                    className={cn(
                      "grid size-10 shrink-0 place-items-center rounded-lg border transition-opacity",
                      action.color,
                    )}
                    aria-hidden="true"
                  >
                  ...
                  <ArrowRight
                    className="ml-auto size-4 shrink-0 text-subtle-foreground transition-transform lg:group-hover:translate-x-0.5"
                    aria-hidden="true"
                  />
                </Link>
              ))}
          ...
          <div className="grid gap-4 xl:grid-cols-3">
            <section
              aria-label="Fluxo de envio"
              className="panel p-4 animate-rise sm:p-5 xl:col-span-2"
            ...
            >
              <header className="mb-4 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-4 text-xs text-muted-foreground">
                  ...
                  <span className="inline-flex items-center gap-1.5">
                    <span className="size-2 rounded-full bg-chart-5" aria-hidden="true" /> Falhas
                  </span>
                </div>
              </header>
            ...
            <section
              aria-label="Saúde da operação"
              className="panel p-4 animate-rise sm:p-5"
            ...
            >
              <header className="mb-4 flex items-center justify-between">
                ...
                <HeartPulse className="size-4 text-success" aria-hidden="true" />
              </header>
                ...
                <>
                  <div>
                    <div className="flex items-end justify-between gap-3">
                      <p className="font-mono text-4xl font-semibold leading-none tabular-nums tracking-tight">
                        {successRate}%
                      </p>
          ...
          <div className="grid gap-4 xl:grid-cols-3">
            ...
            >
              <header className="mb-3 flex flex-wrap items-center justify-between gap-2">
                ...
                <Link
                  to="/ofertas"
                  className="text-xs font-medium text-primary transition-colors lg:hover:text-primary/80"
                >
                  Ver todas
                </Link>
              </header>
              ...
              {(offers.data ?? []).length === 0 ? (
                ...
                <ul className="divide-y divide-border">
                  {(offers.data ?? []).slice(0, 6).map((offer) => (
                    <li
                      key={offer.id}
                      className="flex flex-wrap items-center gap-3 rounded-lg py-2.5 lg:hover:bg-secondary/40"
                    >
